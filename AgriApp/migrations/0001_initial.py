# Generated by Django 5.0.1 on 2024-09-19 05:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('next_growth_stage', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('last_stage_update', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='AgriApp.plantgrowthrecord')),
            ],
        ),
    ]
